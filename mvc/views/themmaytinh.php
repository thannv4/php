	...
	<div class="container my-4">
		<div class="card px-4 pb-4">
			<div class="card-title">
				<h2 class="text-center" style="font-size: 30px; text-align: center; margin-top: 50px;">THÊM MÁY TÍNH</h2>
			</div>
			<form action="/NYH/cquanlimt/themmaytinh" method="post" enctype="multipart/form-data">
